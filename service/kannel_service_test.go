...
func TestKannelServiceGSM7(t *testing.T) {
	kannel := service.NewKannelService("http://149.56.98.254:13013", "chandramouli", "Test12", service.GSM7)
...
func TestKannelServiceUCS2(t *testing.T) {
	kannel := service.NewKannelService("http://149.56.98.254:13013", "chandramouli", "Test12", service.UCS2)
